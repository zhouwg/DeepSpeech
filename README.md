...
This is source code of DeepSpeech(my customized DeepSpeech for project KanTV), derived from original Mozilla's DeepSpeech(which has stopped maintenance since 2021). with a little enhancements(because I'm **NOT** technical expert in AI filed):
