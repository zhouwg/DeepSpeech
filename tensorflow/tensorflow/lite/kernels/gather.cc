...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (positions->type) {
    ...
    case kTfLiteInt32:
      break;
    default:
      context->ReportError(context, __FILE__, __LINE__, "Positions of type '%s' are not supported by gather.",
  ...
  switch (input->type) {
    ...
    default:
      context->ReportError(context,__FILE__, __LINE__, "Type '%s' is not supported by gather.",
