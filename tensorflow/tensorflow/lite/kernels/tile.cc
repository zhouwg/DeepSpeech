...
TfLiteStatus ResizeOutput(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (multipliers->type) {
    ...
    default:
      context->ReportError(
          context, __FILE__, __LINE__, "Multipliers of type '%s' are not supported by tile.",
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
  ...
  switch (output->type) {
    ...
    case kTfLiteBool:
      ...
      break;
    default:
      context->ReportError(context,__FILE__, __LINE__, "Type '%s' is not supported by tile.",
