...
#define ENTER_FUNC() LOGD("enter %s {", __FUNCTION__)

#define LEAVE_FUNC() LOGD("leave %s }", __FUNCTION__)

#define ENTER_JNI_FUNC() LOGJ("enter %s {", __FUNCTION__)

#define LEAVE_JNI_FUNC() LOGJ("leave %s }", __FUNCTION__)
